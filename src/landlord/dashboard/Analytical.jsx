...
import LoginActivitiesCard from '@/landlord/views/agent/components/LoginActivitiesCard';
...
// Agent Modals
import PlanDistributionModal from '@/landlord/views/agent/components/PlanDistributionModal';
import LoggedInUsersModal from '@/landlord/views/agent/components/LoggedInUsersModal';
import ViewUsersListModal from '@/landlord/views/agent/components/ViewUsersListModal';
import TotalSchoolModal from '@/landlord/views/agent/components/TotalSchoolModal';
import TotalTransactionModal from '@/landlord/views/agent/components/TotalTransactionModal';
import TotalSubAgentModal from '@/landlord/views/agent/components/TotalSubAgentModal';
