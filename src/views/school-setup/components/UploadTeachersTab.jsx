        ...
        <Table stickyHeader sx={{ tableLayout: 'fixed', width: '100%' }}>
          <TableHead>
            <TableRow>
              ...
              <TableCell sx={{ fontWeight: 600, width: '12%', bgcolor: '#fff' }}>Staff ID</TableCell>
              <TableCell sx={{ fontWeight: 600, width: '12%', bgcolor: '#fff' }}>Surname</TableCell>
              <TableCell sx={{ fontWeight: 600, width: '15%', bgcolor: '#fff' }}>First Name</TableCell>
              ...
              <TableCell align="center" sx={{ width: '5%', bgcolor: '#fff' }}>Actions</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {teachersLoading ? (
