...
import { Box, Stack, Typography, Tooltip, CircularProgress, useTheme } from "@mui/material";
              ...
              <Tooltip title="Click to view breakdown" placement="top" arrow>
                ...
                >
                  <Stack direction="row" spacing={1.5} alignItems="flex-start" justifyContent="space-between">
                    ...
                    <Box sx={{ minWidth: 0, flex: 1, textAlign: "right", display: "flex", flexDirection: "column", alignItems: "flex-end" }}>
                      <Typography
                        sx={{
                          fontSize: 12,
                          fontWeight: 600,
                      ...
                      {isLoadingVal ? (
                        <Box sx={{ mt: 0.5, display: "flex", alignItems: "center", justifyContent: "flex-end" }}>
                      ...
                      <Stack direction="row" spacing={0.5} alignItems="center" justifyContent="flex-end" sx={{ mt: 0.25, minWidth: 0 }}>
                        <Typography
                          sx={{
                            fontSize: 11,
