...
import Navigation from '@/layouts/landlord/vertical/header/Navigation';

import { IconCategory2, IconMenu2, IconMoon, IconSun, IconX } from '@tabler/icons-react';
import Notifications from '@/layouts/landlord/vertical/header/Notification';

import Profile from '@/layouts/landlord/vertical/header/Profile';
import Search from '@/layouts/landlord/vertical/header/Search';
import Language from '@/layouts/landlord/vertical/header/Language';
