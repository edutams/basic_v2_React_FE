          ...
          >
            <Box
              sx={{
                ...
                borderRadius: 1,
                bgcolor: (theme) =>
                  admission?.admission_status === 'admitted' ? 'success.light' : 'primary.light',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
              }}
            ...
            {admission.admission_status && (
              <Chip
                icon={React.createElement(
                  statusConfig[admission.admission_status]?.icon || PendingIcon,
                  { fontSize: 'small' },
                )}
                label={
                  statusConfig[admission.admission_status]?.label || admission.admission_status
                }
                size="small"
