...
import { Grid, Box, Typography, Button, useTheme, TableContainer, TableRow, TableHead, Table, TableCell, TableBody } from '@mui/material';
    ...
    const tableConfig = (() => {
        ...
        if (isOptional || isCompulsory) {
            return {
                ...
                rows: [
                    { id: 1, class: 'JSS1 A', expected: '₦7,000,234.00', paid: '₦7,000,234', balance: '₦4,000,234' },
                    { id: 2, class: 'JSS1 B', expected: '₦7,000,234.00', paid: '₦7,000,234', balance: '₦4,000,234' },
                    { id: 'total', class: 'Total', expected: '₦7,000,234.00', paid: '₦7,000,234', balance: '₦4,000,234' },
                ]
            };
        }
