  ...
  const SideStat = ({ label, value }) => (
    ...
    >
      ...
      <Typography
        variant="h6"
        fontWeight="700"
        sx={{ color: isDark ? '#fff' : '#9c27b0', mt: 0.5 }}
      >
        # {value}
      </Typography>
    </Card>
    ...
    >
      ...
      <Grid container spacing={2} mb={4}>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          ...
          >
            <Typography variant="h5" fontWeight="700" sx={{ color: isDark ? '#fff' : '#1a3353' }}>
              # 7,000,234.00
            </Typography>
            <Typography
              variant="caption"
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          ...
          >
            <Typography variant="h5" fontWeight="700" sx={{ color: isDark ? '#fff' : '#FACC15' }}>
              # 7,000,234.00
            </Typography>
            <Typography
              variant="caption"
      ...
      >
        ...
        <PrimaryButton
          sx={{
            color: '#ffffff',
            bgcolor: '#27A844',
            '&:hover': { bgcolor: '#27A844', color: '#ffffff' },
            height: 'fit-content',
          }}
        >
          Filter
