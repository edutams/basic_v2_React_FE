...
const UploadCaExamDialog = ({ open, onClose, allocation, onUploaded }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setResult({ severity: 'success', message: 'CA & Exam scores uploaded successfully!' });
...
export default UploadCaExamDialog;
