      ...
      <Grid container spacing={3} alignItems="flex-start">
        <Grid size={{ xs: 12, md: 3 }}>
          <Paper variant="outlined" sx={{ borderRadius: 2, p: 3 }}>
            <Stack spacing={3}>
              ...
              <Box>
                <Typography variant="subtitle2" fontWeight={700} mb={1}>Batch Name</Typography>
                <TextField
                  fullWidth size="small" placeholder="Eg Batch3"
                  value={batchName} onChange={(e) => setBatchName(e.target.value)}
                />
              </Box>

              <Box>
                <Typography variant="subtitle2" fontWeight={700} mb={1}>Entry Term</Typography>
                <TextField
                  fullWidth size="small"
                  value={termLabel || '2025/2026 First Term'}
                  disabled sx={{ bgcolor: 'grey.50' }}
                />
              </Box>
              ...
              <Box sx={{ bgcolor: 'primary.light', p: 2}}>
                <Grid container spacing={2}>
                  <Grid size={{ xs: 6 }}>
                    ...
                    <TextField
                      select fullWidth size="small" value={programmeId}
                      onChange={(e) => { setProgrammeId(e.target.value); setSelectedClasses([]); }}
                    >
                  ...
                  <Grid size={{ xs: 6 }}>
                    <Typography variant="subtitle2" fontWeight={700} mb={1}>Class</Typography>
                    <TextField
                      select fullWidth size="small" value="" disabled={!programmeId}
                      onChange={(e) => {
              ...
              <Box>
                <Box display="flex" justifyContent="space-between" alignItems="flex-start">
                  <Box>
                    <Typography variant="subtitle2" fontWeight={700}>Entrance Exam</Typography>
                    <Typography variant="caption" color="text.secondary">
                      Require an entrance exam for this batch
                    </Typography>
                  </Box>
                  <Switch checked={entranceExam} onChange={(e) => setEntranceExam(e.target.checked)} color="primary" />
                </Box>
                ...
                {entranceExam && (
                  <Box mt={2}>
                    ...
                    <ToggleButtonGroup
                      value={examType} exclusive size="small" sx={{ mb: 2 }}
                      onChange={(_, val) => val && setExamType(val)}
                    >
                      <ToggleButton value="CBT"      sx={{ fontWeight: 700, px: 2 }}>CBT</ToggleButton>
                      <ToggleButton value="Physical" sx={{ fontWeight: 700, px: 2 }}>Physical</ToggleButton>
                    </ToggleButtonGroup>
                    ...
                    <Grid container spacing={2}>
                      <Grid size={{ xs: 6 }}>
                        ...
                        <TextField
                          fullWidth size="small" type="date" value={examDate}
                      ...
                      <Grid size={{ xs: 6 }}>
                        ...
                        <TextField
                          fullWidth size="small" type="number" value={passMark}
              ...
              <Box>
                <Box display="flex" justifyContent="space-between" alignItems="center">
                  <Typography variant="subtitle2" fontWeight={700}>Enable Payment</Typography>
                  <Switch checked={enablePayment} onChange={(e) => setEnablePayment(e.target.checked)} color="primary" />
                </Box>
                  ...
                  <Stack spacing={2} mt={2}>
                    <Box>
                      ...
                      <Stack direction="row" spacing={1} mb={1}>
                        <Chip label="Application Form" size="small" sx={{ bgcolor: 'primary.light', color: 'primary.main', fontWeight: 600, fontSize: 11 }} />
                        <Chip label="Registration Fee" size="small" sx={{ bgcolor: 'primary.light', color: 'primary.main', fontWeight: 600, fontSize: 11 }} />
                      </Stack>
                      <TextField
                        fullWidth size="small" type="number" placeholder="0"
                        value={preAppFee} onChange={(e) => setPreAppFee(e.target.value)}
                    ...
                    <Box>
                      ...
                      <TextField
                        fullWidth size="small" type="number" placeholder="0"
                        value={postAppFee} onChange={(e) => setPostAppFee(e.target.value)}
                        slotProps={{ input: { startAdornment: <InputAdornment position="start">₦</InputAdornment> } }}
                        inputProps={{ min: 0 }}
                      />
                      {postAppFee > 0 && (
              ...
              <Box>
                <Box display="flex" justifyContent="space-between" alignItems="flex-start">
                  <Box>
                    <Typography variant="subtitle2" fontWeight={700}>Enable Admission Letter</Typography>
                    <Typography variant="caption" color="text.secondary">Edit Admission letter</Typography>
                  </Box>
                  <Switch checked={enableLetter} onChange={(e) => setEnableLetter(e.target.checked)} color="primary" />
                </Box>
              </Box>
              ...
              <Box>
                <Box display="flex" justifyContent="space-between" alignItems="flex-start">
                  <Box>
                    ...
                    <Typography variant="caption" color="text.secondary">Open the batch for applications</Typography>
                  </Box>
                  <Switch checked={isOpen} onChange={(e) => setIsOpen(e.target.checked)} color="primary" />
                </Box>
              </Box>
        ...
        <Grid size={{ xs: 12, md: 9 }}>
          ...
          <Box display="flex" justifyContent="flex-end" mt={2}>
            <Button variant="contained" size="large" onClick={handleSubmit} sx={{ fontWeight: 700, px: 4 }}>
