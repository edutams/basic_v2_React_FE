...
const SchemeOfWork = () => {
  ...
  const handleViewDetails = async (id) => {
    ...
    try {
      const data = await tenantSchemeApi.getDetails(id);
  ...
  const handleSaveTopic = async (topicData) => {
    ...
    try {
      if (selectedTopic && selectedTopic.topic_id) {
        ...
        await tenantSchemeApi.addTopic({
          ...topicData,
  ...
  const handleSaveObjective = async (objectiveData) => {
    try {
      if (selectedObjective) {
        await tenantSchemeApi.updateObjective(selectedObjective.id, {
      ...
      if (
        ...
        await tenantSchemeApi.updateSchemeEntry(selectedRow.scheme_of_work_id, {
