...
const responsiveCSS = `
  .tpl12-main { display: flex; flex-wrap: wrap; gap: 16px; }
  .tpl12-left { flex: 3 1 0%; min-width: 0; }
  .tpl12-right { flex: 1 1 0%; min-width: 0; }
  .tpl12-bottom-row { display: flex; flex-wrap: wrap; gap: 4px; }
  .tpl12-bottom-row > div { flex: 1 1 0%; min-width: 0; }
  .tpl12-subject-table { overflow-x: auto; }
  @media (max-width: 900px) {
    .tpl12-main { flex-direction: column; }
    .tpl12-left, .tpl12-right { flex: 1 1 100%; }
    .tpl12-bottom-row { flex-direction: column; }
    .tpl12-bottom-row > div { flex: 1 1 100%; }
  }
`;
    ...
    <div style={{ fontFamily: 'Times New Roman, serif', color: '#000', fontSize: '14px', minWidth: 900 }}>
      ...
      <div className="tpl12-main">
        <div className="tpl12-left">
          ...
          {/* Comments - Teacher first, then HoS */}
          ...
          <div className="tpl12-bottom-row" style={{ marginTop: 12 }}>
            <div>
          ...
          {/* Total Marks / Marks Obtainable */}
          <div style={{ marginTop: 12 }}>
            <p><strong>Total Marks:</strong> {report.total_score}</p>
            <p><strong>Marks Obtainable:</strong> {obtainable}</p>
          </div>
        </div>

        {/* ── Right: Domains ───────────────────────────── */}
        <div className="tpl12-right">
          {/* Affective Skills */}
          <div style={{ marginBottom: 12 }}>
            <div style={{ border: '2px solid #000', padding: '4px 6px', borderRadius: '6px 6px 0 0', background: '#f5f5f5' }}><strong>Affective Skills</strong></div>
            <TableContainer style={{ border: '2px solid #000' }}>
              <Table size="small" style={{ borderCollapse: 'collapse' }}>
                <TableHead>
                  <TableRow>
                    ...
                    <td colSpan={5} style={{ ...innerCellBorder, textAlign: 'center', padding: '3px 6px' }}>Grade</td>
                  </TableRow>
                  <tr>
          ...
          {/* Psychomotor Skills */}
          <div style={{ marginBottom: 12 }}>
            <div style={{ border: '2px solid #000', padding: '4px 6px', borderRadius: '6px 6px 0 0', background: '#f5f5f5' }}><strong>Psychomotor Skills</strong></div>
            <TableContainer style={{ border: '2px solid #000' }}>
              <Table size="small" style={{ borderCollapse: 'collapse' }}>
                <TableHead>
                  <TableRow>
