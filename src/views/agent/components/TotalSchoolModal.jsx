        ...
        >
            ...
            <Box sx={{ borderBottom: 1, borderColor: theme.palette.divider, mb: 3 }}>
                <Tabs value={tabValue} onChange={handleTabChange} sx={{
                    ...
                    <Tab label={<Stack direction="row" spacing={1}><IconChartBar size={18}/> <Typography variant="inherit">Overview</Typography></Stack>} value="1" />
                    <Tab label={<Stack direction="row" spacing={1}><IconSchool size={18}/> <Typography variant="inherit">Agent Performance</Typography></Stack>} value="2" />
                </Tabs>
            </Box>
