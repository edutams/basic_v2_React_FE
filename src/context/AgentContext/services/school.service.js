...
export const createSchool = async (schoolData) => {
  try {
    const res = await api.post('/v1/landlord/create-tenant', schoolData);
...
export const updateSchool = async (id, schoolData) => {
  try {
    const res = await api.put(`/v1/landlord/update-tenant/${id}`, schoolData);
    return res.data;
  } catch (error) {
...
export const deleteSchool = async (id) => {
  try {
    const res = await api.delete(`/v1/landlord/delete-tenant/${id}`);
    return res.data;
  } catch (error) {
...
export const getSchoolDivisions = async () => {
  try {
    const res = await api.get('/v1/landlord/get_school_divisions');
    return res.data?.data;
  } catch (error) {
...
export const storeSchoolCategory = async (data) => {
  try {
    const res = await api.post('/v1/landlord/school_categories', data);
    return res.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export const updateSchoolCategory = async (id, data) => {
  try {
    const res = await api.put(`/v1/landlord/school_categories/${id}`, data);
    return res.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export const deleteSchoolCategory = async (id) => {
  try {
    const res = await api.delete(`/v1/landlord/school_categories/${id}`);
    return res.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export const storeSchoolDivision = async (data) => {
  try {
    const res = await api.post('/v1/landlord/school_divisions', data);
    return res.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export const updateSchoolDivision = async (id, data) => {
  try {
    const res = await api.put(`/v1/landlord/school_divisions/${id}`, data);
    return res.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export const deleteSchoolDivision = async (id) => {
  try {
    const res = await api.delete(`/v1/landlord/school_divisions/${id}`);
    return res.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export const createProspectiveTenant = async (data) => {
  try {
    const res = await api.post('/v1/landlord/prospective-tenants/create-prospective-tenant', data);
    return res.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export const getProspectiveTenant = async (id) => {
  try {
    const res = await api.get(
      `/v1/landlord/prospective-tenants/get-single-prospective-tenant/${id}`,
    );
    return res.data?.data;
  } catch (error) {
    throw error.response?.data || error;
...
export const approveProspectiveTenant = async (id) => {
  try {
    const res = await api.post(`/v1/landlord/prospective-tenants/${id}/approve-prospective-tenant`);
    return res.data;
  } catch (error) {
    throw error.response?.data || error;
  }
...
export const rejectProspectiveTenant = async (id, reason = '') => {
  try {
    const res = await api.post(`/v1/landlord/prospective-tenants/${id}/reject-prospective-tenant`, {
      reason,
    });
    return res.data;
  } catch (error) {
...
export const deleteProspectiveTenant = async (id) => {
  try {
    const res = await api.delete(
      `/v1/landlord/prospective-tenants/${id}/delete-prospective-tenant`,
    );
    return res.data;
  } catch (error) {
    throw error.response?.data || error;
