    ...
    return (<>
        <Container sx={{
            ...
            <Box borderRadius="24px" overflow="hidden" position="relative" sx={{
                ...
                <Container maxWidth="lg">
                    <Grid container spacing={3} alignItems="center">
                        <Grid
                            ...
                            }}>Develop with feature-rich React.js Dashboard</Typography>
                            <Stack spacing={{ xs: 1, sm: 2 }} direction="row" flexWrap="wrap" mb={3}>
                                ...
                                <Button variant="outlined" size="large" href="/auth/register">Register as Member</Button>
                            </Stack>
                ...
                {lgUp ?
                    <img src={DesignCol} alt="design" width={1200} height={365} style={{
