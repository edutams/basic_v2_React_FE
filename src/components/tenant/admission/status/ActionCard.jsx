...
import { Description as DescriptionIcon, CreditCard as CreditCardIcon } from '@mui/icons-material';
...
const ActionCard = ({ amount, dueLabel, onPay, onViewLetter }) => {
  ...
  return (
    <Paper sx={{ borderRadius: 3, overflow: 'hidden' }}>
      <Box
        sx={{
          background: `linear-gradient(90deg,#15161a 0%,${theme.palette.primary.main} 100%)`,
          p: 2,
          color: '#fff',
        }}
      >
