    ...
    (<Grid container spacing={3} textAlign="center">
      <Grid
        ...
        >
          ...
          <Typography variant="h5" fontWeight={500}>Total Tickets</Typography>
        </BoxStyled>
      </Grid>
      <Grid
        size={{
        ...
        >
          ...
          <Typography variant="h5" fontWeight={500}>Pending Tickets</Typography>
        </BoxStyled>
      </Grid>
      <Grid
        size={{
        ...
        >
          ...
          <Typography variant="h5" fontWeight={500}>Open Tickets</Typography>
        </BoxStyled>
      </Grid>
      <Grid
        size={{
        ...
        >
          ...
          <Typography variant="h5" fontWeight={500}>Closed Tickets</Typography>
        </BoxStyled>
      </Grid>
    </Grid>)
  );
