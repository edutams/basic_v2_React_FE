...
// Fetch class arms by class
export const fetchClassArmsByClass = async (classId, params = {}) => {
  const response = await api.get(`/curriculum/class-arms/by-class/${classId}`, { params });
  return response.data;
};
