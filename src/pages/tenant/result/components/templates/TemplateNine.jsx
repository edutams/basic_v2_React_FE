...
const responsiveCSS = `
  .tpl9-main { display: flex; flex-wrap: wrap; gap: 16px; }
  .tpl9-left { flex: 3 1 0%; min-width: 0; }
  .tpl9-right { flex: 1 1 0%; min-width: 0; }
  .tpl9-bottom-row { display: flex; flex-wrap: wrap; gap: 4px; }
  .tpl9-bottom-row > div { flex: 1 1 0%; min-width: 0; }
  .tpl9-subject-table { overflow-x: auto; }
  @media (max-width: 900px) {
    .tpl9-main { flex-direction: column; }
    .tpl9-left, .tpl9-right { flex: 1 1 100%; }
    .tpl9-bottom-row { flex-direction: column; }
    .tpl9-bottom-row > div { flex: 1 1 100%; }
  }
`;

const TemplateNine = ({ student, report, sessionTerm, className, gradeScale }) => {
    ...
    <div style={{ fontFamily: 'Times New Roman, serif', color: '#000', fontSize: '14px', minWidth: 900 }}>
      ...
      <div className="tpl9-main">
        <div className="tpl9-left">
          ...
          <div className="tpl9-bottom-row" style={{ marginTop: 12 }}>
            <div>
        ...
        <div className="tpl9-right">
          ...
          {/* Total Score / Position / Percentage */}
