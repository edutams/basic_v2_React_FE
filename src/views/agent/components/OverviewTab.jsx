...
const OverviewTab = ({ data }) => {
  ...
  const planOptions = {
    ...
    colors: data.planDistribution.map((d) => d.color || '#A855F7'), // Use color from data or default to purple
    legend: {
      position: 'bottom',
          ...
          <Stack spacing={3} sx={{ height: '100%' }}>
            ...
            >
              <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2}>
                ...
                <IconButton size="small" onClick={handlePlanModalOpen}>
                  <IconChartBar size={18} color="#64748B" />
                </IconButton>
              </Stack>
            ...
            <TableContainer sx={{ height: 'calc(100% - 60px)' }}>
              <Table size="small">
                <TableHead sx={{ bgcolor: '#F8FAFC' }}>
                  <TableRow>
                    <TableCell sx={{ fontWeight: 800, fontSize: '11px', color: '#64748B' }}>
                      School
                    </TableCell>
                    <TableCell sx={{ fontWeight: 800, fontSize: '11px', color: '#64748B' }}>
                      Agent
                        ...
                        >
                          <Box>
                            <Typography
                              variant="caption"
                              fontWeight={800}
                              sx={{ color: '#1E293B', fontSize: '10px', display: 'block' }}
                            >
                              {row.agent}
                            </Typography>
                            <Typography
            ...
            <TableContainer>
              <Table>
                <TableHead sx={{ bgcolor: '#EAFDF6' }}>
                  <TableRow>
                    <TableCell sx={{ fontWeight: 800, fontSize: '12px', color: '#1E293B' }}>
                      S/N
                    </TableCell>
                    <TableCell sx={{ fontWeight: 800, fontSize: '12px', color: '#1E293B' }}>
                      Name
