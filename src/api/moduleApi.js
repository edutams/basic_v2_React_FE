...
const moduleApi = {
   ...
   */
  getModule: async (id) => {
    const response = await api.get(`/landlord/v1/edu_tier/modules/get_agent_module/${id}`);
    return response.data.data;
  },
  ...
  updateModule: async (id, data) => {
    const response = await api.put(`/landlord/v1/edu_tier/modules/update_module/${id}`, data);
    return response.data.data;
  },
   ...
   * Uses /api/v1/landlord/v1/edu_tier/modules endpoint
  ...
  getTenantModule: async (id) => {
    const response = await api.get(`/landlord/v1/edu_tier/modules/${id}`);
    return response.data.data;
  },
  ...
  createTenantModule: async (data) => {
    const response = await api.post('/landlord/v1/edu_tier/modules', data);
    return response.data.data;
  },
  ...
  updateTenantModule: async (id, data) => {
    const response = await api.put(`/landlord/v1/edu_tier/modules/${id}`, data);
    return response.data.data;
  },
  ...
  deleteTenantModule: async (id) => {
    const response = await api.delete(`/landlord/v1/edu_tier/modules/${id}`);
    return response.data.data;
  },
  ...
  getAllTenantModules: async () => {
    const response = await api.get('/landlord/v1/edu_tier/modules/all');
    return response.data.data;
  },
  ...
  getTenantSidebarModules: async () => {
    const response = await api.get('/landlord/v1/edu_tier/sidebar-modules');
    return response.data.data;
  },
  ...
  getTenantPackages: async () => {
    const response = await api.get('/landlord/v1/edu_tier/packages');
    return response.data.data;
  },
  ...
  getTenantPackageModules: async (packageId) => {
    const response = await api.get(`/landlord/v1/edu_tier/packages/${packageId}/modules`);
    return response.data.data;
  },
  ...
  saveTenantPackageModules: async (packageId, moduleIds) => {
    const response = await api.post('/landlord/v1/edu_tier/save-package-modules', {
      package_id: packageId,
      module_ids: moduleIds,
    });
    return response.data.data;
